...
var GridSheet = function (_React$Component) {
  _inherits(GridSheet, _React$Component);

  function GridSheet() {
    _classCallCheck(this, GridSheet);

    return _possibleConstructorReturn(this, (GridSheet.__proto__ || Object.getPrototypeOf(GridSheet)).apply(this, arguments));
  }

  _createClass(GridSheet, [{
    key: "render",
