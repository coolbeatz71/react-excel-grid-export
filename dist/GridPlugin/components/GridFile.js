...
var GridFile = function (_React$Component) {
  ...
  function GridFile(props) {
    ...
    var _this = _possibleConstructorReturn(this, (GridFile.__proto__ || Object.getPrototypeOf(GridFile)).call(this, props));

    _initialiseProps.call(_this);

    if (_this.props.hideElement) _this.download();else _this.handleDownload = _this.download.bind(_this);
