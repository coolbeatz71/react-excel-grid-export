...
class App extends Component {
  render() {
    return (
      <div>
        <GridFile element={<button>Download Data With Styles</button>}>
          <GridSheet dataSet={multiDataSet} name="Organization" />
        </GridFile>
      </div>
    );
  }
...
![Grid File Outpu](https://blvenglu.sirv.com/github/styled_excel_sheet.png)
